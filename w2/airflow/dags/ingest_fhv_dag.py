...
DATASET_URL = (
    f"https://d37ci6vzurychx.cloudfront.net/trip-data/fhv_tripdata_{YEAR_MONTH}.parquet"
)
OUTPUT_FILE = f"{AIRFLOW_HOME}/fhv_tripdata_{YEAR_MONTH}.parquet"
TABLE_NAME = f"fhv_taxi_{YEAR_MONTH}"
