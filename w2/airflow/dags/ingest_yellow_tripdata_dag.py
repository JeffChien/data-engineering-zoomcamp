...
DATASET_URL = f"https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_{YEAR_MONTH}.parquet"
OUTPUT_FILE = f"{AIRFLOW_HOME}/yellow_tripdata_{YEAR_MONTH}.parquet"
TABLE_NAME = f"yellow_taxi_{YEAR_MONTH}"
